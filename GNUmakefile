...
test:
	...
	LANG= LC_ALL= TAR_SCM_TESTMODE=1 PYTHONPATH=. $(PYTHON) tests/test.py 2>&1 | tee ./test.log

test3:
	: Running the test suite.  Please be patient - this takes a few minutes ...
	LANG= LC_ALL= TAR_SCM_TESTMODE=1 PYTHONPATH=. python3 tests/test.py 2>&1 | tee ./test3.log
