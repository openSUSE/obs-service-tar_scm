...
class Changes():
    def import_xml_parser(self) -> Any:
    ...
    def parse_servicedata_xml(self, srcdir: str) -> Any:
    ...
    def extract_tar_scm_service(self, root: Any, url: str) -> Any:
    ...
    def get_changesrevision(self, tar_scm_service: Any) -> Any:
    ...
    def read_changes_revision(
            self,
            url: str,
            srcdir: str,
            outdir: str) -> Dict[str, Optional[str]]:
        """
    ...
    def write_changes(
        ...
        with io.open(tmp_filename, 'w', encoding="UTF-8") as tmp_fp:
            tmp_fp.write(text)

        shutil.move(tmp_filename, changes_filename)

    def get_changesauthor(self, args: Any) -> str:
